...
try:
	...
	# We will just loop round switching 4 IR lamps On/Off
	while True:
	################## 4 IR lamps here ##########################
		...
		# Leave all 4 lamps on for 3.6 more seconds (4s total acute heat stimulation time)
		time.sleep(3.6)

		# Turn all 4 sockets/lamps off
		GPIO.output (13, False)
		GPIO.output (16, False)
		GPIO.output (15, True)
		GPIO.output (11, True)
