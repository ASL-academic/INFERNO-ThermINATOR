...
########commented block start########
#This line runs the INFERNO_batchprocessing_flagger_8fps.py python script
python2.7 /home/test_platform/INFERNO_reversal_flagger_8fps.py
########commented block end########

########commented block start########
#This line moves concatenated .blobs used as input for the 
#INFERNO_batchprocessing_flagger_8fps.py and the .txt 
#INFERNO_batchprocessing_flagger_8fps.py output files containing reversal data from the blobs folder to the output folder 
mv blobs output 
########commented block end########